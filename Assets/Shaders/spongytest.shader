...
Shader "Shader Forge/spongytest" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _node_4151; uniform float4 _node_4151_ST;
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 _node_4151_var = UnpackNormal(tex2D(_node_4151,TRANSFORM_TEX(i.uv0, _node_4151)));
                float3 normalLocal = _node_4151_var.rgb;
